...
import catFish from "../../assets/png/smoked-african-catfish.png";
...
import { capitalizeFirstLetter, formatNumber, naira } from "../../utils/fx/fx";
...
export const ProductSection = () => {
    return (
        <div className="d-flex position-relative my-4 py-2 w-100 md-height-400">
            ...
            />
            <img
                className="position-absolute w-300px top-left"
                src={leftBg}
                alt=""
            />
            <img
...
export const PageTop = ({
    title = "Delivering a sustainable aquaculture production process",
...
export function BottomCta({
    title = "Buy healthy and oven dried catfish from us - your trusted source",
    ...
    return (
        <div className="bg-green p-1 md-p-0 d-flex justify-space-around flex-column md-flex-row align-center text-white w-80 md-h-150 br-2 my-5 mx-auto">
            <h2 className="md-w-40 text-white text-center md-text-left">
                        ...
                        <div className="md-mr-3 w-100">
                            <div className="d-flex flex-column md-flex-row align-start">
                                ...
                                <div className="md-ml-1">
                                    <div>
                                        <div className="text-yellow fs-0-8-rem mb-0-3">
                                            Qty
                                        </div>
                                    </div>
...
export const CartItem = ({
    ...
    return (
        <div className="d-flex mb-1 justify-space-around align-center ">
            ...
            <img
                className=" w-100-px md-w-100-px mr-1"
                src={image}
                alt="cart item"
            />
            <div className="flex-grow-1">
                ...
                <p className="text-gray fs-1">
                    <span className="mr-1">Qty:{quantity}</span>{" "}
                    <span>Type:{type}</span>
                </p>
            </div>
